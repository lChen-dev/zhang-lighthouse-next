...
import ExplorePostsUi from '@components/blog/pages/ExplorePostsPage';
...
const ExplorePostsPage: React.FC<Props> = ({ doc = null, popNew = null }: Props) => {
  return (
    <Store>
      <ExplorePostsUi doc={doc} popNew={popNew} />
    </Store>
  );
};
