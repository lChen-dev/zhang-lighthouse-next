...
const ExploreMoreUi: React.FC<Props> = ({ doc, popNew }: Props) => {
  const [title, setTitle] = useState<string>('EXPLORE BLOGS');
  ...
  const categoriesList = ['Most Popular', `What's New`, 'Blogs', 'City Guides'];
