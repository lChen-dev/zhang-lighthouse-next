const countryTimezones: { [key: string]: string } = {
  ...
  'America/Fort_Wayne': 'United States of America',
  ...
  'America/Indianapolis': 'United States of America',
  ...
  'US/East-Indiana': 'United States of America',
};

/**
 * @param timezone timezone string
 * @description find country by timezone string
 */
const findCountryByTimeZone: Function = (timezone: string): string => countryTimezones[timezone] || '';
